...
interface InChatCallPopupProps {
  isOpen: boolean;
  callerName: string;
...
export default function InChatCallPopup({
  isOpen,
  callerName,
  callerAddress,
  callType,
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="absolute top-full left-0 right-0 mt-2 mx-4 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 backdrop-blur-xl border-2 border-green-500/50 rounded-2xl shadow-2xl z-[80] overflow-hidden"
        >
